...
class IdsRequest1(object):
    ...
    def __init__(self, ids=None, _configuration=None):  # noqa: E501
        """IdsRequest1 - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def ids(self):
        """Gets the ids of this IdsRequest1.  # noqa: E501


        :return: The ids of this IdsRequest1.  # noqa: E501
        :rtype: list[float]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this IdsRequest1.


        :param ids: The ids of this IdsRequest1.  # noqa: E501
        :type: list[float]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IdsRequest1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdsRequest1):
            return False
