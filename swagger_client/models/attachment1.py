...
class Attachment1(object):
    ...
    def __init__(self, blob_content=None, _configuration=None):  # noqa: E501
        """Attachment1 - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._blob_content = None
    ...
    def blob_content(self):
        """Gets the blob_content of this Attachment1.  # noqa: E501


        :return: The blob_content of this Attachment1.  # noqa: E501
        :rtype: object
        """
        return self._blob_content

    @blob_content.setter
    def blob_content(self, blob_content):
        """Sets the blob_content of this Attachment1.


        :param blob_content: The blob_content of this Attachment1.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Attachment1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Attachment1):
            return False
