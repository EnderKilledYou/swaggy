...
class FemaSegments(object):
    ...
    """
    swagger_types = {
        'fema_segments': 'list[FemaSegment]'
    }

    attribute_map = {
        'fema_segments': 'femaSegments'
    }

    def __init__(self, fema_segments=None, _configuration=None):  # noqa: E501
        """FemaSegments - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._fema_segments = None
        self.discriminator = None

        if fema_segments is not None:
            self.fema_segments = fema_segments

    @property
    def fema_segments(self):
        """Gets the fema_segments of this FemaSegments.  # noqa: E501


        :return: The fema_segments of this FemaSegments.  # noqa: E501
        :rtype: list[FemaSegment]
        """
        return self._fema_segments

    @fema_segments.setter
    def fema_segments(self, fema_segments):
        """Sets the fema_segments of this FemaSegments.


        :param fema_segments: The fema_segments of this FemaSegments.  # noqa: E501
        :type: list[FemaSegment]
        """

        self._fema_segments = fema_segments
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FemaSegments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FemaSegments):
            return False
