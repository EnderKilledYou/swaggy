...
class EmergencySponsor(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """EmergencySponsor - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmergencySponsor, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmergencySponsor):
            return False
