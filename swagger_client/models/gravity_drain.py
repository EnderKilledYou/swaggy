...
class GravityDrain(object):
    ...
    def __init__(self, steward_org_ids=None, _configuration=None):  # noqa: E501
        """GravityDrain - a model defined in Swagger"""  # noqa: E501
    ...
    def steward_org_ids(self):
        """Gets the steward_org_ids of this GravityDrain.  # noqa: E501


        :return: The steward_org_ids of this GravityDrain.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def steward_org_ids(self, steward_org_ids):
        """Sets the steward_org_ids of this GravityDrain.


        :param steward_org_ids: The steward_org_ids of this GravityDrain.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GravityDrain, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GravityDrain):
            return False
