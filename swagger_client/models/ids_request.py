...
class IdsRequest(object):
    ...
    def __init__(self, ids=None, _configuration=None):  # noqa: E501
        """IdsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def ids(self):
        """Gets the ids of this IdsRequest.  # noqa: E501


        :return: The ids of this IdsRequest.  # noqa: E501
        :rtype: list[float]
        """
        return self._ids
    ...
    @ids.setter
    def ids(self, ids):
        """Sets the ids of this IdsRequest.


        :param ids: The ids of this IdsRequest.  # noqa: E501
        :type: list[float]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdsRequest):
            return False
