...
class SystemInspectionDocument(object):
    ...
    def __init__(self, name=None, _configuration=None):  # noqa: E501
        """SystemInspectionDocument - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SystemInspectionDocument.  # noqa: E501


        :return: The name of this SystemInspectionDocument.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SystemInspectionDocument.


        :param name: The name of this SystemInspectionDocument.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SystemInspectionDocument, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SystemInspectionDocument):
            return False
