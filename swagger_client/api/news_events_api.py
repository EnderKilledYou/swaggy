...
class NewsEventsApi(object):
    ...
    def events_id_get(self, id, **kwargs):  # noqa: E501
        ...
        Gets an event article  # noqa: E501
        ...
        :param int id: ID of event article (required)
        :return: object
    ...
    def get_all_events(self, **kwargs):  # noqa: E501
        ...
        Gets all event articles  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_all_news_articles(self, **kwargs):  # noqa: E501
        """get_all_news_articles  # noqa: E501

        Gets all news articles  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_news_articles(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_news_articles_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_news_articles_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_news_articles_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_news_articles  # noqa: E501

        Gets all news articles  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_news_articles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_news_articles" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def news_id_get(self, id, **kwargs):  # noqa: E501
        """news_id_get  # noqa: E501

        Gets a news article  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.news_id_get(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: ID of news article (required)
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.news_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.news_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def news_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """news_id_get  # noqa: E501

        Gets a news article  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.news_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `news_id_get`")  # noqa: E501
