...
class LisApi(object):
    ...
    def lis_get(self, **kwargs):  # noqa: E501
        """lis_get  # noqa: E501

        Gets latest LIS version and download URL  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lis_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.lis_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.lis_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def lis_get_with_http_info(self, **kwargs):  # noqa: E501
        """lis_get  # noqa: E501

        Gets latest LIS version and download URL  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lis_get_with_http_info(async_req=True)
        >>> result = thread.get()
