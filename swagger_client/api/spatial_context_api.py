...
class SpatialContextApi(object):
    ...
    def get_all_contexts_param(self, **kwargs):  # noqa: E501
        """get_all_contexts_param  # noqa: E501

        Gets all Contexts for a system/segments  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_contexts_param(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int system_id: systemId
        :param int segment_id: segmentId
        :param str type: type of context
        :return: list[object]
        ...
        if kwargs.get('async_req'):
            return self.get_all_contexts_param_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_contexts_param_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_contexts_param_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_contexts_param  # noqa: E501

        Gets all Contexts for a system/segments  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_contexts_param_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['system_id', 'segment_id', 'type']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_all_contexts_param" % key
                )
            params[key] = val
        del params['kwargs']
