...
class TestSegmentsApi(unittest.TestCase):
    ...
    def test_get_all_segment_p2_names(self):
        """Test case for get_all_segment_p2_names

        """
        pass

    def test_get_all_segment_sponsors(self):
        """Test case for get_all_segment_sponsors
