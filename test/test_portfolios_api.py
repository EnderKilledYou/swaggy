...
class TestPortfoliosApi(unittest.TestCase):
    ...
    def test_get_all_portfolio_systems(self):
        """Test case for get_all_portfolio_systems
    ...
    def test_get_system_ids(self):
        """Test case for get_system_ids

        """
        pass

    def test_portfolio_id_get(self):
        """Test case for portfolio_id_get

        """
        pass

    def test_portfolio_system_id_get(self):
        """Test case for portfolio_system_id_get
